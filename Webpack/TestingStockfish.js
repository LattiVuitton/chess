...
try {
    var INIT_ENGINE = require("./node_modules/stockfish/src/stockfish.js");
    
    var wasmPath = require("./node_modules/path").join(__dirname, "./node_modules/stockfish/src/stockfish.wasm");
    var mod = {
