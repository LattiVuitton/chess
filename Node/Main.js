...
for (let i = 0; i < roundsToPlay; i++){
    ...
    const winner = game.runGame(agent1, agent2);
...
console.log("Agent 1       :  " + agent1Wins + " (" + Math.round((100 * agent1Wins / gamesPlayed + Number.EPSILON) * round) / round + " %)")
console.log("Agent 2       :  " + agent2Wins + " (" + Math.round((100 * agent2Wins / gamesPlayed + Number.EPSILON) * round) / round + " %)")
